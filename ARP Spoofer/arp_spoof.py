...
while True:
    ...
    print("\r[+] Sent packets: " + str(sent_packets_count)),  # Print the number of packets sent
    sys.stdout.flush() # Flush the output buffer to ensure the print statement is executed immediately
